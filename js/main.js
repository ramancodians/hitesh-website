...
$(document).ready(function () {
    ...
    //init readmore library for reviews
...
// fetch more videos when user clicks more.
$('.next-page').click(function () {
	getVideos();
});

function getVideos() {
    // show loader as we'll be fetching videos
    $('.video-loader').show();
